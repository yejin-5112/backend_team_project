...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .menu { width: 70px; text-align: center; font-size: 16px; cursor: pointer; }
        .add_item { visibility: hidden; }
...
<header>
    <div class="header_wrap">
        ...
        <div class="menu_wrap">
            <div class="menu add_item">상품 추가</div>
            <div class="menu login" onclick="location.href='login.jsp'">로그인</div>
            <div class="menu profile" onclick="location.href='profile.jsp'">마이페이지</div>
            <div class="menu cart" onclick="location.href='cart.jsp'">장바구니</div>
        </div>
    </div>
</header>
